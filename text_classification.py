...
tf.flags.DEFINE_string("filter_sizes", "3,4,5", "Comma-separated filter sizes (default: '2,4,5')")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # Checkout directory, Tensorflow assumes this directory already exists
